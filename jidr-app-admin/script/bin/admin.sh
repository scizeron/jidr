...
function download
{
 ...
 if [ $USE_S3 -eq 0 ] ; then
  ...
  logMessage "Download \"${ARTIFACT_ID}\" from ${DOWNLOAD_ARTIFACT_URL} to ${WORK_DIR}/${ARTIFACT_FILENAME} ..."
  ...
  logMessage "Download \"${ARTIFACT}\" from ${DOWNLOAD_ARTIFACT_URL} to ${WORK_DIR}/${ARTIFACT_FILENAME} ..."
